 ...
 */
@Component(name = "TextGridManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class TextGridManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public TextGridManipulator() {
		super();
		setName("TextGridManipulator");
	 ...
	 */
	public static class TextGridMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'TextGridTraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "TextGridTraversal", this);
