...
public class TextGridImporter extends PepperImporterImpl implements PepperImporter{
	...
	private static final Logger logger = LoggerFactory.getLogger(TextGridImporter.class);
	 ...
	 * sample mapper of type {@link TextGridMapper}, which only produces a fixed
	 * document-structure in method {@link TextGridMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link TextGridMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link TextGridMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link TextGridMapper#mapSCorpus()}. <br/>
