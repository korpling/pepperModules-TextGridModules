...
import org.corpus_tools.pepperModules.textgrid.TextGridManipulator;
 ...
 * {@link TextGridManipulator} class. Feel free to adapt and enhance this test
 ...
 */
public class TextGridManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new TextGridManipulator());
	}
